...
mongoose.connect "mongodb://gjoga:ttee@ds031777.mongolab.com:31777/gjoga", (err) ->
  console.error "Mongo connection failed" if err
  console.log "connected to joga_yelp"
...
yelp.search {term: "pickup+soccer",location: "San Francisco", limit : "1"}, (error, stream) ->
    YelpDB.create stream, (err, returnedStream) -> 
        console.log err
