...
(function() {
  var COOKIE_SECRET, EXPRESS_SID_KEY, app, appKeys, challenge, configDB, cookieParser, express, flash, games, genUID, google, http, io, ladder, mailer, mandrill, mandrill_client, moment, mongoose, notifs, passport, path, port, redis, relations, scheduler, server, sessionStore, sio, social, socket, users, xp, _;
