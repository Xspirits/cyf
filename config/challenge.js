...
(function() {
  ...
  module.exports = function(_, mailer, moment, genUID) {
    return {
      ...
      create: function(req, done) {
        var data, description, durationD, durationH, game, newChallenge, title, uID, user, _this;
        data = req.body;
        user = req.user;
        _this = this;
        title = data["title"];
      ...
      validateOngoing: function(data, done) {
        ...
        return Ongoing.findOne({
          ...
          return ongoing.save(function(err) {
            ...
            return self.completedBy(ongoing._idChallenge._id, completedByArr, function(done) {
              return done(ongoing);
            });
          });
        });
